...
- **Working Set after Pass 1 (50 docs)**: 59.2 MB
- **Working Set after Pass 2 (50 docs)**: 62.2 MB
- **Inter-Pass Working Set Growth**: 3.0 MB (demonstrates cache boundedness)
- **Peak Working Set**: 0.061 GB (62.2 MB, Budget: <= 1.2 GB) -> PASS
