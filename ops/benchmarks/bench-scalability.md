...
- **Working Set after Cold Load**: 28.1 MB
- **Working Set after Pass 1 (50 docs)**: 56.4 MB
- **Working Set after Pass 2 (50 docs)**: 58.8 MB
- **Inter-Pass Working Set Growth**: 2.3 MB (demonstrates cache boundedness)
- **Peak Working Set**: 0.057 GB (58.6 MB, Budget: <= 1.2 GB) -> PASS
