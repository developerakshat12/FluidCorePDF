...
- **Working Set after Pass 2 (50 docs)**: 28.7 MB
- **Inter-Pass Working Set Growth**: 0.5 MB (demonstrates cache boundedness)
- **Peak Working Set**: 0.029 GB (29.6 MB, Budget: <= 1.2 GB) -> PASS
